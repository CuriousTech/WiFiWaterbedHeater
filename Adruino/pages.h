const char page1[] PROGMEM =
   ...
   "  hi=80\n"
   "  for(i=0;i<cnt;i++){\n"
   "if(d.item[i][2]>hi) hi=d.item[i][2]\n"
   "if(d.item[i][2]-d.item[i][3]<lo) lo=d.item[i][2]-d.item[i][3]\n"
   "  }\n"
   ...
   "<tr><td align=\"left\"> &nbsp; Name &nbsp; &nbsp; &nbsp; &nbsp;Time</td><td>Temp</td><td align=\"left\">&nbsp; &nbsp; Threshold</td></tr>\n"
   "<tr><td colspan=3 id='r0' style=\"display:none\"><input id=N0 type=text size=6> <input id=S0 type=text size=3> <input id=T0 type=text size=3> <input id=H0 type=text size=2> <input value=\"Set\" type='button' onclick=\"{setEntry(0)}\"></td></tr>\n"
   "<tr><td colspan=3 id='r1' style=\"display:none\"><input id=N1 type=text size=6> <input id=S1 type=text size=3> <input id=T1 type=text size=3> <input id=H1 type=text size=2> <input value=\"Set\" type='button' onclick=\"{setEntry(1)}\"></td></tr>\n"
   "<tr><td colspan=3 id='r2' style=\"display:none\"><input id=N2 type=text size=6> <input id=S2 type=text size=3> <input id=T2 type=text size=3> <input id=H2 type=text size=2> <input value=\"Set\" type='button' onclick=\"{setEntry(2)}\"></td></tr>\n"
   "<tr><td colspan=3 id='r3' style=\"display:none\"><input id=N3 type=text size=6> <input id=S3 type=text size=3> <input id=T3 type=text size=3> <input id=H3 type=text size=2> <input value=\"Set\" type='button' onclick=\"{setEntry(3)}\"></td></tr>\n"
   "<tr><td colspan=3 id='r4' style=\"display:none\"><input id=N4 type=text size=6> <input id=S4 type=text size=3> <input id=T4 type=text size=3> <input id=H4 type=text size=2> <input value=\"Set\" type='button' onclick=\"{setEntry(4)}\"></td></tr>\n"
   "<tr><td colspan=3 id='r5' style=\"display:none\"><input id=N5 type=text size=6> <input id=S5 type=text size=3> <input id=T5 type=text size=3> <input id=H5 type=text size=2> <input value=\"Set\" type='button' onclick=\"{setEntry(5)}\"></td></tr>\n"
   "<tr><td colspan=3 id='r6' style=\"display:none\"><input id=N6 type=text size=6> <input id=S6 type=text size=3> <input id=T6 type=text size=3> <input id=H6 type=text size=2> <input value=\"Set\" type='button' onclick=\"{setEntry(6)}\"></td></tr>\n"
   "<tr><td colspan=3 id='r7' style=\"display:none\"><input id=N7 type=text size=6> <input id=S7 type=text size=3> <input id=T7 type=text size=3> <input id=H7 type=text size=2> <input value=\"Set\" type='button' onclick=\"{setEntry(7)}\"></td></tr>\n"
   "<tr><td colspan=3><canvas id=\"canva\" width=\"288\" height=\"100\" style=\"border:1px dotted;float:left\" onclick=\"draw()\"></canvas></td></tr>\n"
   "<tr height=32><td id='m'></td><td><div id='tc'>$0.00</div></td><td>$<input id='K' type=text size=2 value='0.1457'><input value=\"Set\" type='button' onclick=\"{setPPK()}\"></td></tr>\n"
   "<tr><td colspan=3 id='tm0'></td></tr>\n"
   "<tr><td colspan=3 id='tm1'></td></tr>\n"
   "<tr><td colspan=3 id='tm2'></td></tr>\n"
   "<tr><td colspan=3 id='tm3'></td></tr>\n"
   "<tr><td></td><td colspan=2><input id=\"myKey\" name=\"key\" type=text size=40 placeholder=\"password\" style=\"width: 100px\"><input type=\"button\" value=\"Save\" onClick=\"{localStorage.setItem('key', key = document.all.myKey.value)}\"></td></tr>\n"
   "</table>\n"
   "</body>\n"
   "</html>\n";
