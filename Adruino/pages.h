const char index_page[] PROGMEM =
   ...
   "//ws=new WebSocket(\"ws://192.168.0.116:82/ws\")\n"
   ...
   "  a.on.innerHTML=(d.on?\"<font color='red'><b>\":\"\")+d.hiTemp+\"&degF\"+(d.on?\"</b></font>\":\"\")\n"
   "  a.rt.innerHTML=+d.temp+'&degF'\n"
   "  a.rh.innerHTML=+d.rh+'%'\n"
   "  a.tc.innerHTML='$'+d.tc\n"
   " }\n"
   " else if(event=='set')\n"
   ...
   "<tr><td colspan=2>Vaca <input id='vt' type=text size=2 value='-10'><input type='button' id='vo' onclick=\"{setVaca()}\"> &nbsp &nbsp </td>\n"
